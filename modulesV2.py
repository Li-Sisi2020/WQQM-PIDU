...
def normal_irrigation_restrict(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array, fert_type_array,
    ...
    if havePond:
        ...
        if orderDitch == 1:
            ...
            h_yan = HDiff_FD1 - HDiff_FD2
    else:
        area_p = 0.0
        if orderDitch == 1:
            h_yan = 100
        else:
            h_yan = 100 + HDiff_FD1 - HDiff_FD2
    ...
    for column in prcp_d.columns:
        ...
        while date_n < len(prcp_d.index):
            ...
            if (dayofYear < startday_doy) | (dayofYear > endday_doy):
                ...
                if (havePond is True) & (orderDitch == 2):
                    if (Hd1 <= 0) & (Hd2 <= 0) & (Hp <= 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + Kr_d2 * 1.2 * PET * area_d2 + Kr_p * 1.2 * PET * area_p
                    elif (Hd1 <= 0) & (Hd2 <= 0) & (Hp > 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + Kr_d2 * 1.2 * PET * area_d2 + kc_p * PET * area_p_d + \
                                  0.60 * PET * (area_p - area_p_d)
                    elif (Hd1 <= 0) & (Hd2 > 0) & (Hp > 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + kc_d2 * PET * area_d2_d + kc_p * PET * area_p_d + \
                    ...
                    if (Hd1 <= 0) & (Hp <= 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + Kr_p * 1.2 * PET * area_p
                    elif (Hd1 <= 0) & (Hp > 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + kc_p * PET * area_p_d + \
                                  0.60 * PET * (area_p - area_p_d)
                    else:
                        ET_pd_v = kc_d1 * PET * area_d1_d + kc_p * PET * area_p_d + 0.60 * PET * (
                                area_pd - area_d1_d - area_p_d)
                    ...
                    if (Hd1 <= 0) & (Hd2 <= 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + Kr_d2 * 1.2 * PET * area_d2
                    elif (Hd1 <= 0) & (Hd2 > 0):
                        ET_pd_v = Kr_d1 * 1.2 * PET * area_d1 + kc_d2 * PET * area_d2_d + \
