...
def main(parameter_file, run_id):
    """ 参数录入 """
    ...
    if (pre_risk == 0) & (recycle_irrg == 0):
        output_normal = modules_simple1.normal(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array,
                                       fert_type_array,
        ...
        output_bmp = modules_simple1.pre_risk(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array,
        ...
        output_bmp = modules_simple1.recycle_irrg(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array,
                                          fert_type_array, TN0_array, TP0_array, TN_I, TP_I, area_f, Ks, Fc0_f, Fc0_pd,
        ...
        output_bmp = modules_simple1.both_bmps(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array,
                                       fert_type_array, TN0_array, TP0_array, TN_I, TP_I, area_f, Ks, Fc0_f, Fc0_pd,
                                       TN_P0,
                                       TN_P1, TP_P, TN_rate_lch, TN_rate_lch_lat, TP_rate_lch, TP_rate_lch_lat, ENC0_dp,
                                       EPC0_dp, ENCR_f, EPCR_f, vf_N_array, vf_P, H_V_sr, vf_N_pd, vf_P_pd,
                                       risk_days, min_level_prerisk, min_level_recycle, Hf_Hdp_sr, run_id, output_dir, graph)

    if ((pre_risk == 1) | (recycle_irrg == 1)):
        if bmp_compare == 1:
            normal_comp = modules_simple1.normal(prcp_d, startDay, endDay, wtr_mng_d, pet_d, ditch_par, pond_par, F_doy_array,
                                         fert_type_array,
                                         TN0_array, TP0_array, TN_I, TP_I, area_f, Ks, Fc0_f, Fc0_pd, TN_P0, TN_P1,
                                         TP_P,
                                         TN_rate_lch, TN_rate_lch_lat, TP_rate_lch, TP_rate_lch_lat, ENC0_dp, EPC0_dp,
                                         ENCR_f, EPCR_f,
                                         vf_N_array, vf_P, H_V_sr, vf_N_pd, vf_P_pd, run_id, output_dir=0, graph=0)
